...
class Weapon():
    ...
    def update(self, player):
        ...
        if pygame.mouse.get_pressed()[0] and self.fired == False and (pygame.time.get_ticks() - self.last_shot) >= shot_cd: #left click
...
class Arrow(pygame.sprite.Sprite):
    def __init__(self, image, x, y, angle):
        ...
        # Calculate arrow speeds based on angle
    ...
    def update(self, screen_scroll, obstacle_tiles, enemy_list):
        ...
        # Check for arrow and wall collision
        for tile in obstacle_tiles:
            if tile[1].colliderect(self.rect):
                self.kill()
                break

        # Handle off-screen arrows
...
class Fireball(pygame.sprite.Sprite):
    def __init__(self, image, x, y, target_x, target_y):
        ...
        self.dx = math.cos(math.radians(self.angle)) * constants.FB_SPEED
        self.dy = -(math.sin(math.radians(self.angle)) * constants.FB_SPEED)
